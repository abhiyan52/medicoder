...
def get_prompt(prompt_name: str, version: str | None = None) -> str | None:
    """
    ...
    try:
        ...
        if version:
            ...
            if not target_file:
                logger.warning(
                    "Specific prompt version not found",
            ...
            logger.info(
                "Using latest prompt version", prompt_name=prompt_name, version=latest_v
            )
